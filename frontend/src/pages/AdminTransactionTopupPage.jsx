// src/pages/AdminTransactionTopupPage.jsx
import React, { useState, useEffect } from 'react';
import axios from '../api/api';
import authService from '../services/authService';

const AdminTransactionTopupPage = () => {
  ...
  // Fetch top-up transactions; on the backend, ensure filtering by type
  const fetchTransactions = async () => {
    try {
      setLoading(true);
      const res = await axios.get('/donations/admin/transactions/topup/', {
        headers: {
      ...
      setError('Failed to fetch top-up transactions.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-full">
      <h1 className="text-3xl font-bold text-center mb-6">Top-Up Transactions</h1>
...
export default AdminTransactionTopupPage;
