...
const ResetPasswordPage = () => {
  ...
  // Récupère le numéro de téléphone depuis l'état de redirection, s'il existe
  const initialPhone = location.state?.phone_number || '';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-cyan-300 via-sky-300 to-white">
      <div className="bg-white shadow-md rounded-lg p-8 w-full max-w-md mt-16 relative">
        <h2 className="text-center text-2xl font-bold text-cyan-500">Réinitialisation du mot de passe</h2>
        ...
        <form onSubmit={handleResetPassword} className="space-y-4 mt-6" autoComplete="off">
          ...
          <div>
            <div className="mt-2 flex flex-row-reverse items-center rounded-full bg-gray-200 pr-3 focus-within:ring-2 focus-within:ring-cyan-500">
              <i className="bi bi-key text-gray-500 ml-2"></i>
              <input
                type="text"
                value={otp}
